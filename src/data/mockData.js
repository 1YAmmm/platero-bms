...
export const BARANGAY_INFO = {
  ...
  captain: 'Hon. Ricardo S. Magtibay',
  secretary: 'Maria Luisa D. Santos',
  treasurer: 'Jose Antonio P. Reyes',
  hotline: '(049) 123-4567',
  email: 'brgy.platero@binan.gov.ph',
  address: 'Barangay Hall, Platero, Biñan City, Laguna',
  established: '1978',
  population: '12,450',
  households: '3,102',
  area: '2.4 km²',
...
export const ANNOUNCEMENTS = [
  {
    ...
    date: '2025-05-15',
    category: 'Event',
    content: 'Join us for the monthly Barangay Clean-Up Drive on May 15, 2025 at 6:00 AM. All residents are encouraged to participate.',
    pinned: true,
  },
  {
    id: 2,
    ...
    date: '2025-05-20',
    category: 'Health',
    content: 'Free medical consultations, blood pressure monitoring, and medicines will be provided on May 20 at the Barangay Health Center.',
    pinned: true,
  },
  {
    id: 3,
    ...
    date: '2025-05-10',
    category: 'Service',
    content: 'Senior citizens may apply for their OSCA ID at the Barangay Hall every Monday and Wednesday, 8:00 AM – 12:00 PM.',
    pinned: false,
  },
  {
    id: 4,
    ...
    date: '2025-06-01',
    category: 'Governance',
    content: 'The quarterly Barangay Assembly will be held on June 1, 2025, 2:00 PM at the Barangay Covered Court.',
    pinned: false,
  },
];
...
export let COMPLAINTS = [
  {
    ...
    description: 'Garbage has not been collected in our street for two weeks. The smell is unbearable and there are flies everywhere. This is a health hazard.',
    status: 'Pending',
    priority: 'High',
  ...
  },
  {
    ...
    description: 'Neighbor plays loud music until 2:00 AM almost every night, disturbing the peace and sleep of residents in the area.',
    status: 'Resolved',
    priority: 'Medium',
    dateFiled: '2025-04-15',
    dateResolved: '2025-04-22',
    assignedTo: 'Kagawad Ramos',
    notes: 'Both parties agreed to a settlement. Noise ordinance ordinance explained to respondent.',
  },
  {
    id: 'CMP-2025-003',
    ...
    description: 'Someone vandalized my fence with graffiti. I have CCTV footage. Requesting barangay intervention to identify and apprehend the suspect.',
